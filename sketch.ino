...
//Rev3: 02-09-2024 Refinamento do código e ajustes para o uso de um IP público próprio
...
const char* default_BROKER_MQTT = "REMOVIDO DO GITHUB PARA A SEGURANÇA DO SERVIDOR"; // IP do Broker MQTT
